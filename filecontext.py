...
def convert_java_to_text(project_path, output_file):
    ...
    with open(output_file, 'w', encoding='utf-8') as outfile:
        for java_file in glob.glob(os.path.join(project_path, '**/*.java'), recursive=True):
            try:
...
# 使用示例
project_directory = "/home/change/labelcode/labelMark/src/main/java/com/example/labelMark"  # 替换为你的项目路径
output_text_file = "output_springboot.txt"  # 输出文件名
